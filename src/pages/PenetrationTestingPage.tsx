              ...
              <div className="flex flex-wrap justify-center gap-3">
                {tools.map((category) => (
                  <a
                    ...
                    className="px-3 py-1.5 rounded-md border border-white/10 bg-background-surface-1 text-text-secondary text-sm hover:text-red-400 hover:border-red-500/40 transition-all duration-250"
                  >
                    {category.category}
                  </a>
                ))}
