  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'RTL-SDR Blog',
        description:
          'A practical reference site for low-cost SDR hardware, tutorials, and real-world examples for getting started with radio analysis.',
        features: [
          'Hardware and driver guidance',
          'Tutorials for SDR beginners',
          'Device-specific troubleshooting',
          'Useful background for RF experimentation',
        ],
